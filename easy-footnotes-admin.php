...
if ( isset( $_POST['easy_footnote_hidden'] ) ) {
	...
	$easyFootnotesCustomLabelMarkup = $footnoteOptions['customLabelMarkup'];
...
<div class="wrap">
	...
	<form name="easy_footnotes_form" method="post">
		...
		<p><?php esc_html_e( 'Customize Footnotes Label Markup:', 'easy-footnotes'); ?><input name="easy_footnotes_custom_label_markup" value="<?php echo esc_attr($easyFootnotesCustomLabelMarkup); ?>" size="40" />
