...
<div class="wrap">
    ...
    <form name="easy_footnotes_form" method="post" action="<?php echo str_replace('%7E', '~', $_SERVER['REQUEST_URI']); ?>">
        ...
        <p><?php esc_html_e("Customize Footnotes Label Markup: "); ?><input name="easy_footnotes_custom_label_markup" value="<?php echo esc_attr($easyFootnotesCustomLabelMarkup); ?>" size="40" />
